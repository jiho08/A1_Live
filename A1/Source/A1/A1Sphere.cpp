...
void AA1Sphere::BeginPlay()
{
	...
	if (Sphere)
	{
		Sphere->OnComponentHit.AddDynamic(this, &AA1Sphere::OnShpereHit);
	}
}
...
void AA1Sphere::OnShpereHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
