...
void AA1Actor::Tick(float DeltaTime)
{
	...
	/*FVector Location = GetActorLocation() + FVector::ForwardVector * MovementSpeed * DeltaTime;
	...
	FRotator NewRotator = FRotator(Rotation.Pitch, Rotation.Yaw * RotationRate * DeltaTime, Rotation.Roll);
